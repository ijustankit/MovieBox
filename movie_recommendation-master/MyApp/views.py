...
tmdb = TMDb()
tmdb.api_key = "c93973bdc0a90db9bb7e0c7311cfa1b8" #Insert your own API key
def main_code(movieName):
    movie_dataFrame = pd.read_csv(r'F:\MAY-JUNE\python\Project\movie_recommendation-master\movie_recommendation-master\MyApp\movies.csv')
    rating_dataFrame = pd.read_csv(r'F:\MAY-JUNE\python\Project\movie_recommendation-master\movie_recommendation-master\MyApp\ratings.csv')
